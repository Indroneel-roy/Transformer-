...
class SentenceEmbedding(nn.Module):
    ...
    def __init__(self, max_sequence_length, d_model, language_to_index, START_TOKEN, END_TOKEN, PADDING_TOKEN):
        ...
        # Get UNK token index, default to 0 if not found
        self.UNK_TOKEN_IDX = self.language_to_index.get('<UNK>', 0)
    ...
    def batch_tokenize(self, batch, start_token, end_token):
        ...
        def tokenize(sentence, start_token, end_token):
            ...
            sentence_word_indicies = [
                self.language_to_index.get(token, self.UNK_TOKEN_IDX) 
            ...
            # CRITICAL FIX: Truncate if too long, then pad if too short
            ...
            # Padding to exact max_sequence_length
            while len(sentence_word_indicies) < self.max_sequence_length:
                sentence_word_indicies.append(self.language_to_index[self.PADDING_TOKEN])
            
            # VALIDATION: Ensure all indices are within valid range
            sentence_word_indicies = [
                idx if 0 <= idx < self.vocab_size else self.UNK_TOKEN_IDX 
